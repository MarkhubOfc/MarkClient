...
extern "C" JNIEXPORT void JNICALL
Java_com_mark_client_MainActivity_nativeInitSurface(JNIEnv* env, jobject, jobject surface, jobject assetManager, jint width, jint height) {
    ...
    Client::get().initImGui(g_window, g_width, g_height, g_assetManager);
    g_initialized = true;
}
